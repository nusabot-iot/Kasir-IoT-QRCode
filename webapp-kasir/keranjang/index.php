...
<head>
  ...
  <title>Keranjang Toko ABC</title>
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="../index3.html" class="navbar-brand">
        ...
        <span class="brand-text font-weight-light">Toko ABC</span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="tunda.php" class="nav-link">Tunda Keranjang</a>
          </li>
        </ul>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <button id="stop-button" class="btn btn-primary">Batalkan Scan</button>
                </div>
                ...
                <form method="post" action="">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-6">
                        <input type="number" name="id_barang" min="1" id="hasil" class="form-control" placeholder="ID Barang" required>
                      </div>
                      <div class="col-6">
                  ...
                  <div class="form-group">
                    <input type="submit" name="tambah" class="btn btn-primary" value="Tambahkan Ke Keranjang">
                  </div>
                </form>
              </div>
            </div>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  while($row = mysqli_fetch_array($result)){
                    ...
                    <tr>
                      ...
                      <td><a href="?batal=<?php echo $row['id'] ?>" class="btn btn-primary">Batal</a></td>
                    </tr>
                    <?php 
